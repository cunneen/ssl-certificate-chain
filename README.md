...
Here's a blank template to get started. To avoid retyping too much info, do a search and replace with your text editor for the following: `cunneen`, `ssl-certificate-chain`, ``, `linkedin_username`, `email_client`, `email`, `ssl-certificate-chain`, `A nodejs module for downloading a SSL certificate chain from a website`, `MIT`
...
2. Clone the repo
   ```sh
   git clone https://github.com/cunneen/ssl-certificate-chain.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin cunneen/ssl-certificate-chain
